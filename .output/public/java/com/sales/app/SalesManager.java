...
public class SalesManager {
    ...
    private static void dashboard() {
        ...
        System.out.println("Today's Sales   : " + dao.getTodaySales());
        System.out.println("Monthly Sales   : "
                + dao.getMonthlySales(c.get(java.util.Calendar.MONTH) + 1, c.get(java.util.Calendar.YEAR)));
        System.out.println("Total Sales     : " + dao.getTotalSales());
        System.out.println("Quantity Sold   : " + dao.getTotalQuantity());
        System.out.println("Best Product    : " + dao.getBestSellingProduct());
    }
    ...
    private static void print(List<Sales> list) {
        ...
        System.out.println("Transactions   : " + list.size());
        System.out.println("Average Sale   : " + (amt / list.size()));
    }
}